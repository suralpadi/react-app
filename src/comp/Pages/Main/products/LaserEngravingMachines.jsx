...
class LaserEngravingMachines extends React.Component {
    render() {
        return (
            <>
                <div className="page-content">
                    <Banner BannerBg={OurProductBanner} title={"Laser Engraving Machines"} />
...
export default LaserEngravingMachines;