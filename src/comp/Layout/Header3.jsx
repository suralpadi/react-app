...
class Header3 extends React.Component {
    ...
    state = { isSearchActive: false, isQuoteActive: false, isContactFormActive: false, isMobileMenuActive: false};
    ...
    render() {
        ...
        return (
            <>
                <header className={isMobileMenuActive ? "site-header header-style-3 mobile-sider-drawer-menu home-three active" : "site-header header-style-3 mobile-sider-drawer-menu home-three"} >
