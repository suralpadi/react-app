...
class Team5 extends React.Component {
    render() {
        return (
            <>
                <div className="section-full p-t120 p-b90 site-bg-black">
                            ...
                            <div className="row wt-separator-two-part-row">
                                <div className="col-lg-8 col-md-12 wt-separator-two-part-left">
                                    ...
                                    <div className="section-head left wt-small-separator-outer when-bg-dark">
                                        ...
                                        <h2 className="wt-title">Expert Contractors</h2>
                                    </div>
                                    {/* TITLE END*/}
                                </div>
                                <div className="col-lg-4 col-md-12 wt-separator-two-part-right text-right">
                                    <NavLink to="/team-details" className="site-button sb-bdr-dark">All Member</NavLink>
                                </div>
                            </div>
                        </div>
                        {/* TITLE END*/}
                                    ...
                                    <div key={index} className="col-lg-4 col-md-6 col-sm-12 m-b30">
                                        <div className="wt-team-2">
                                            ...
                                            <div className="wt-info">
                                                <div className="team-detail white">
